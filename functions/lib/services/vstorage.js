...
exports.vstorageConfig = {
    accessKeyId: process.env.VSTORAGE_ACCESS_KEY ||
        process.env.VITE_VSTORAGE_ACCESS_KEY ||
        'cb1d2453d51a5936b5eee3be7685d1dc',
    secretAccessKey: process.env.VSTORAGE_SECRET_KEY ||
...
async function uploadFile(key, file, contentType = 'application/octet-stream', metadata) {
    try {
        ...
        const url = await (0, s3_request_presigner_1.getSignedUrl)(exports.s3, getCommand, { expiresIn: 3600 }); // 1 hour
        return {
            url,
            key,
        };
