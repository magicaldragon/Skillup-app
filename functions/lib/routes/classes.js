...
router.post('/', auth_1.verifyToken, auth_1.requireTeacher, async (req, res) => {
  ...
  try {
    ...
    const levelCode =
      (levelData === null || levelData === void 0 ? void 0 : levelData.code) ||
      ((_a = levelData === null || levelData === void 0 ? void 0 : levelData.name) === null ||
      _a === void 0
        ? void 0
        : _a.substring(0, 2).toUpperCase()) ||
      'SU';
