...
router.get('/profile', auth_1.verifyToken, async (req, res) => {
  try {
    ...
    const { firebaseUid } = userData,
      safeUserData = __rest(userData, ['firebaseUid']);
    ...
    for (const firebaseUser of firebaseUsers) {
      try {
        ...
        if (existingUserQuery.empty) {
          ...
          let role = 'student'; // default
          if (
            (_a = firebaseUser.email) === null || _a === void 0
              ? void 0
              : _a.includes('@teacher.skillup')
          ) {
            role = 'teacher';
          } else if (
            ((_b = firebaseUser.email) === null || _b === void 0
              ? void 0
              : _b.includes('@admin.skillup')) ||
            ((_c = firebaseUser.email) === null || _c === void 0
              ? void 0
              : _c.includes('admin@admin.skillup'))
          ) {
            role = 'admin';
          }
          const newUserData = {
            ...
            name:
              ...
              ((_d = firebaseUser.email) === null || _d === void 0 ? void 0 : _d.split('@')[0]) ||
              'Unknown',
            role: role,
            status: 'active',
            createdAt: admin.firestore.FieldValue.serverTimestamp(),
