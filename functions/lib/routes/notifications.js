...
exports.notificationsRouter = exports.createNotification = void 0;
    ...
    try {
      ...
      const notifications = snapshot.docs
        ...
        .sort((a, b) => {
          ...
          const aTime =
            ((_b = (_a = a.createdAt) === null || _a === void 0 ? void 0 : _a.toDate) === null ||
            _b === void 0
              ? void 0
              : _b.call(_a)) || new Date(a.createdAt || 0);
          const bTime =
            ((_d = (_c = b.createdAt) === null || _c === void 0 ? void 0 : _c.toDate) === null ||
            _d === void 0
              ? void 0
              : _d.call(_c)) || new Date(b.createdAt || 0);
...
router.patch('/:id/read', auth_1.verifyToken, async (req, res) => {
  try {
    if (!req.user) {
    ...
    if (
      (notificationData === null || notificationData === void 0
        ? void 0
        : notificationData.userId) !== req.user.userId
    ) {
...
router.patch('/mark-all-read', auth_1.verifyToken, async (req, res) => {
  try {
    if (!req.user) {
      return res.status(401).json({ message: 'User not authenticated' });
    }
