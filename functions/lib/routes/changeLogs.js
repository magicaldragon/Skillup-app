...
router.get('/', auth_1.verifyToken, async (req, res) => {
    ...
    try {
        ...
        if (role === 'student') {
            ...
            query = query.where('entityId', '==', (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId);
        }
...
router.get('/:id', auth_1.verifyToken, async (req, res) => {
    ...
    try {
        ...
        if (role === 'student' && changeLogData.entityId !== ((_a = req.user) === null || _a === void 0 ? void 0 : _a.userId)) {
...
router.get('/entity/:entityType/:entityId', auth_1.verifyToken, async (req, res) => {
    ...
    try {
        ...
        if (role === 'student' && entityType === 'user' && entityId !== ((_a = req.user) === null || _a === void 0 ? void 0 : _a.userId)) {
            return res.status(403).json({ message: 'Access denied' });
        }
        else if (role === 'teacher') {
            if (entityType === 'class') {
                ...
                const teacherClasses = await admin
                    .firestore()
                    .collection('classes')
                    .where('teacherId', '==', (_d = req.user) === null || _d === void 0 ? void 0 : _d.userId)
                    .get();
                const classIds = teacherClasses.docs.map((doc) => doc.id);
                const hasAccess = classIds.some((classId) => userClassIds.includes(classId));
                if (!hasAccess) {
