...
router.post('/', auth_1.verifyToken, auth_1.requireAdmin, async (req, res) => {
  ...
  try {
    ...
    if (
      !studentDoc.exists ||
      ((_a = studentDoc.data()) === null || _a === void 0 ? void 0 : _a.role) !== 'student'
    ) {
...
router.get('/:id', auth_1.verifyToken, async (req, res) => {
  ...
  try {
    ...
    if (
      ...
      if (
        !classDoc.exists ||
        ((_b = classDoc.data()) === null || _b === void 0 ? void 0 : _b.teacherId) !==
...
router.get('/student/:studentId', auth_1.verifyToken, async (req, res) => {
  ...
  try {
    ...
    if (
      role === 'student' &&
      studentId !== ((_a = req.user) === null || _a === void 0 ? void 0 : _a.userId)
    ) {
      return res.status(403).json({ message: 'Access denied' });
    } else if (role === 'teacher') {
      ...
      const classIds =
        (studentData === null || studentData === void 0 ? void 0 : studentData.classIds) || [];
      if (classIds.length === 0) {
        return res.json([]);
      }
      const teacherClasses = await admin
