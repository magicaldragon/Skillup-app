    ...
    try {
        ...
        if (classDoc.exists) {
            ...
            if (classData === null || classData === void 0 ? void 0 : classData.levelId) {
                ...
                if (levelDoc.exists) {
                    levelName = ((_a = levelDoc.data()) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown';
                }
            }
        }
        ...
        const reportData = {
            ...
            reporterName: (reporterData === null || reporterData === void 0 ? void 0 : reporterData.name) || 'Unknown',
            reporterEnglishName: (reporterData === null || reporterData === void 0 ? void 0 : reporterData.englishName) || '',
            studentId,
            studentName: (studentData === null || studentData === void 0 ? void 0 : studentData.name) || 'Unknown',
            studentEnglishName: (studentData === null || studentData === void 0 ? void 0 : studentData.englishName) || '',
            classId,
            className,
            levelName,
            problems,
        ...
        try {
            ...
            adminUsersSnapshot.docs.forEach((adminDoc) => {
                (0, notifications_1.createNotification)(adminDoc.id, 'student_report', 'New Student Report', `New report submitted for ${(studentData === null || studentData === void 0 ? void 0 : studentData.name) || 'Unknown Student'} in ${className}`, docRef.id);
            });
            ...
            staffUsersSnapshot.docs.forEach((staffDoc) => {
                (0, notifications_1.createNotification)(staffDoc.id, 'student_report', 'New Student Report', `New report submitted for ${(studentData === null || studentData === void 0 ? void 0 : studentData.name) || 'Unknown Student'} in ${className}`, docRef.id);
            });
        }
