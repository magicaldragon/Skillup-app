...
async function createAdminAccount() {
  try {
    ...
    console.log(
      '   Auth: https://console.firebase.google.com/project/skillup-3beaf/authentication/users'
    );
    console.log(
      '   Firestore: https://console.firebase.google.com/project/skillup-3beaf/firestore/data'
    );
  } catch (error) {
